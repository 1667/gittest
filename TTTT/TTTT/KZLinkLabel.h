...
typedef NS_ENUM(NSInteger, KZLinkType)
{
    ...
    KZLinkTypeCustom,     //自定义的链接
    KZLinkTypeAllClicked     //自定义的链接
...
@property (nonatomic,strong)  NSMutableArray *customLinkArray;
...
@property (nonatomic, assign) BOOL canAllClicked;
@property (nonatomic, assign) BOOL isAllClicked;
